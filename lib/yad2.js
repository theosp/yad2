var cities = ["ירושלים", "תל אביב יפו", "חיפה", "ראשון לציון", "אשדוד", "פתח תקווה", "באר שבע", "נתניה", "חולון", "בני ברק", "רמת גן", "בת ים", "רחובות", "אשקלון", "הרצליה", "כפר סבא", "בית שמש", "חדרה", "מודיעין", "מכבים", "רעות", "נצרת", "לוד", "רעננה", "רמלה", "גבעתיים", "נהריה", "קריית אתא", "הוד השרון", "קריית גת", "אילת", "עכו", "כרמיאל", "רמת השרון", "טבריה", "עפולה", "נס ציונה", "נצרת עילית", "ראש העין", "אלעד", "ביתר עילית", "קרית מוצקין", "קריית ים", "קריית ביאליק", "מעלה אדומים", "אור יהודה", "קריית אונו", "יבנה", "דימונה", "צפת", "טמרה", "נתיבות", "יהוד מונוסון", "אופקים", "מגדל העמק", "נשר", "ערד", "טירה", "גבעת שמואל", "קריית שמונה", "מעלות תרשיחא", "קריית מלאכי", "יוקנעם עילית", "טירת כרמל", "אריאל", "בית שאן", "אור עקיבא"];

var letters = " אבגדהוזחטיכלמנסעפקרשת".split("");
...
var neighborhood_suggestor_url_generator = function (city, chars) {
    ...
    console.log("http://www.yad2.co.il/ajax/nhood_autocomplete.php?AreaID=&q=" + chars + "&City=" + city);
...
var get_neighborhood_names_by_suggestions_api = function () {
    var names = {};
    var time_between_requests = 5000;
...
get_neighborhood_names_by_suggestions_api();
